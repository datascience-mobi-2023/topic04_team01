...
```{r}
dengue_data_com_2 = dengue_data_com_2[,2:5]
...
# Annahme: DataFrame heißt "T.huss_reshaped" und die Spalte mit den Reporting Areas heißt "Reporting_area"

# Ändere den Namen der gewünschten Reporting Areas
T.huss_reshaped <- T.huss_reshaped %>% 
  mutate(reporting_area = ifelse(reporting_area == "Bueng Kan", "Bungkan", reporting_area))

# Überprüfe den DataFrame mit den umbenannten Reporting Areas
print(T.huss_reshaped)
```
