...
den_hum_longformat <- read.csv("./den_hum_longformat.csv")
monsoon_longformat <- read.csv("./monsoon_longformat.csv")
popu_density_den_hum <- read.csv("./stacked_dengue_population_density_humidity.csv")
```
