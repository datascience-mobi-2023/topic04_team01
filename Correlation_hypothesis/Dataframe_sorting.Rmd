...
##we need a copy of the humidity dataframe 
...
To be able to use this dataframe for correlation testing, the humidity data needs to be added as well
...
Finally we can add these to the longformat dataframe as well and save the dataframe in the repository
...
## 4. Dengue Dataframe that does not contain NA's
...
For example the percentage of cases in january 2018 in the Amnat Charoen Province is calculated by deviding the cases of january 2006 by the total cases of 2006.
...
## 5. Normalized dataframe without NA's
...
## 6. Monsoon season dataframes

### 6.1 Normalized dengue Dataframe sorted into monsoon seasons
...
### 6.2 Humidity Dataframe sorted into monsoon seasons
...
## 7. Yearly stacked monsoon season dataframe with both humidity and dengue cases
...
To be able to work with them they need to be combined into a dataframe.
...
let's save this dataframe in the repository
...
Let's save this dataframe in the repository to avoid having to run all this code just to use the dataframe
