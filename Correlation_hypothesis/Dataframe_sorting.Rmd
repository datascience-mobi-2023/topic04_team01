...
The inter-monsoon season months are December, January and February, the pre-monsoon seasons are March, April and May, the monsoon seasons are June, July, August and September and finally the post-monsoon seasons are October and November. The Dengue monsoon seasons will be calculated by summing the respective months up. As Bungkan has again gained NAs because the population data from 2006-2011 is missing, I decided to loose this one province. 
...
For the humidity data mean for the months mentioned above is used. To avoid clashes with different vector lengths, Bungkan will be removed here as well 

```{r}
#normalized dengue data without NA's
##the bungkan province needs to be removed in row 4 
dengue_wo_NA_norm <- dengue_wo_NA_norm[-4,]
...
ly(humidity_mon[numColumns], as.numeric)
